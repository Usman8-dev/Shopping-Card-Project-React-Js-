    ...
    <nav className="w-full bg-[#141412] border-b border-[#2A2A26]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          >
            Card
            <span className="absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full bg-[#e59b1a] text-[#141412] text-[11px] font-bold leading-none">10</span>
          </Link>
        </div>
      </div>
    </nav>
